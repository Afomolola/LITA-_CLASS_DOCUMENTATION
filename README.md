...
# TABLE OF CONTENT : BASICS OF DATA ANALYSIS
## PROJECT TITLE : Learning Documentation
## PROJECT OVERVIEW
This is a project to help with exposure into the powerful world of Data Analysis, how to begin, the tools needed and navigation of the tools.
